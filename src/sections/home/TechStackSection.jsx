            ...
            >
                {[...items, ...items].map((item, index) => (
                    <div
                        ...
                        className="tech-box flex items-center justify-center gap-2 sm:gap-3"
                    >
                        <Image
                            src={item.img}
                            alt={item.title}
...
function TechStackSection() {
    return (
        <section data-theme="light" className=" relative bg-bg pb-16 sm:pb-20">
            ...
            <div className="text-center mb-12 sm:mb-16 px-4">
                ...
                <div className="heading-primary mt-2">
                    The <span className="italic text-[#FB6557]">stack</span> behind reliable{" "}
                    <span className="italic text-[#FE9139]">scalable</span> systems
                </div>
